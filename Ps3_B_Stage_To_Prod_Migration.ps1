				...
				ELSEIF ($Tables_To_Process_Coupler -gt 0)
					{
						...
						[STRING]$Processing_Key_Coupler_Qry = "SELECT COALESCE(MIN(Stage_To_Prod_Key),0) AS Next_Table
														FROM dbo.Stage_To_Prod
														WHERE 1 = 1
															AND Tier = 1
						...
						$Update_Stage_To_Prod = "UPDATE dbo.Stage_To_Prod 
											...
											WHERE 1 = 1
												AND Stage_To_Prod_Key = $Processing_Key_Coupler
												"
				...
				ELSEIF ($Tables_To_Process_Tier_2A -gt 0 -AND $Tables_To_Process_Coupler -eq 0)
					{
						...
						[STRING]$Processing_Key_Tier_2A_Qry = "SELECT COALESCE(MIN(Stage_To_Prod_Key),0) AS Next_Table
														FROM dbo.Stage_To_Prod
														WHERE 1 = 1
															AND Tier = 2
						...
						$Update_Stage_To_Prod = "UPDATE dbo.Stage_To_Prod 
											...
											WHERE 1 = 1
												AND Stage_To_Prod_Key = $Processing_Key_Tier_2A
												"
				...
				ELSEIF ($Tables_To_Process_Tier_2B -gt 0 -AND $Tables_To_Process_Tier_2A -eq 0 -AND $Tables_To_Process_Coupler -eq 0)
					{
						...
						[STRING]$Processing_Key_Tier_2B_Qry = "SELECT COALESCE(MIN(Stage_To_Prod_Key),0) AS Next_Table
														FROM dbo.Stage_To_Prod
														WHERE 1 = 1
															AND Tier = 2
															AND (Tier_2_Stage IS NULL 
						...
						$Update_Stage_To_Prod = "UPDATE dbo.Stage_To_Prod 
											SET Tier_2_Stage = '$Job_Name'                   
												, Tier_2_Stage_DateTime = '$Update_DateTime'
											WHERE 1 = 1
												AND Stage_To_Prod_Key = $Processing_Key_Tier_2B
												"
				...
				ELSEIF ($Tables_To_Process_Tier_3 -gt 0 -AND $Tables_To_Process_Coupler -eq 0)
					{
						...
						[STRING]$Processing_Key_Tier_3_Qry = "SELECT COALESCE(MIN(Stage_To_Prod_Key),0) AS Next_Table
														FROM dbo.Stage_To_Prod
														WHERE 1 = 1
															AND Tier = 3
						...
						$Update_Stage_To_Prod = "UPDATE dbo.Stage_To_Prod 
											...
											WHERE 1 = 1
												AND Stage_To_Prod_Key = $Processing_Key_Tier_3
												"
				...
				ELSEIF ($Tables_To_Process_Tier_4 -gt 0 -AND $Tables_To_Process_Coupler -eq 0)
					{
						...
						[STRING]$Processing_Key_Tier_4_Qry = "SELECT COALESCE(MIN(Stage_To_Prod_Key),0) AS Next_Table
														FROM dbo.Stage_To_Prod
														WHERE 1 = 1
															AND Tier = 4															
						...
						$Update_Stage_To_Prod = "UPDATE dbo.Stage_To_Prod 
											...
											WHERE 1 = 1
												AND Stage_To_Prod_Key = $Processing_Key_Tier_4
												"
				...
				ELSEIF ($Tables_To_Process_Tier_5 -gt 0 -AND $Tables_To_Process_Coupler -eq 0 -AND $Tables_To_Process_Tier_4 -eq 0)
					{
						...
						[STRING]$Processing_Key_Tier_5_Qry = "SELECT COALESCE(MIN(Stage_To_Prod_Key),0) AS Next_Table
														FROM dbo.Stage_To_Prod
														WHERE 1 = 1
															AND Tier = 5															
						...
						$Update_Stage_To_Prod = "UPDATE dbo.Stage_To_Prod 
											...
											WHERE 1 = 1
												AND Stage_To_Prod_Key = $Processing_Key_Tier_5
												"
				...
				ELSEIF ($Tables_To_Process_Tier_6 -gt 0 -AND $Tables_To_Process_Coupler -eq 0 -AND $Tables_To_Process_Tier_5 -eq 0)
					{
						...
						[STRING]$Processing_Key_Tier_6_Qry = "SELECT COALESCE(MIN(Stage_To_Prod_Key),0) AS Next_Table
														FROM dbo.Stage_To_Prod
														WHERE 1 = 1
															AND Tier = 6															
						...
						$Update_Stage_To_Prod = "UPDATE dbo.Stage_To_Prod 
											...
											WHERE 1 = 1
												AND Stage_To_Prod_Key = $Processing_Key_Tier_6
												"
				...
				ELSEIF ($Tables_To_Process_Tier_7 -gt 0 -AND $Tables_To_Process_Coupler -eq 0 -AND $Tables_To_Process_Tier_6 -eq 0)
					{
						...
						[STRING]$Processing_Key_Tier_7_Qry = "SELECT COALESCE(MIN(Stage_To_Prod_Key),0) AS Next_Table
														FROM dbo.Stage_To_Prod
														WHERE 1 = 1
															AND Tier = 7															
						...
						$Update_Stage_To_Prod = "UPDATE dbo.Stage_To_Prod 
											...
											WHERE 1 = 1
												AND Stage_To_Prod_Key = $Processing_Key_Tier_7
												"
				...
				ELSEIF ($Tables_To_Process_Tier_8 -gt 0 -AND $Tables_To_Process_Coupler -eq 0 -AND $Tables_To_Process_Tier_7 -eq 0)
					{
						...
						[STRING]$Processing_Key_Tier_8_Qry = "SELECT COALESCE(MIN(Stage_To_Prod_Key),0) AS Next_Table
														FROM dbo.Stage_To_Prod
														WHERE 1 = 1
															AND Tier = 8															
						...
						$Update_Stage_To_Prod = "UPDATE dbo.Stage_To_Prod 
											...
											WHERE 1 = 1
												AND Stage_To_Prod_Key = $Processing_Key_Tier_8
												"
				...
				ELSEIF ($Tables_To_Process_Tier_9 -gt 0 -AND $Tables_To_Process_Coupler -eq 0 -AND $Tables_To_Process_Tier_8 -eq 0)
					{
						...
						[STRING]$Processing_Key_Tier_9_Qry = "SELECT COALESCE(MIN(Stage_To_Prod_Key),0) AS Next_Table
														FROM dbo.Stage_To_Prod
														WHERE 1 = 1
															AND Tier = 9															
						...
						$Update_Stage_To_Prod = "UPDATE dbo.Stage_To_Prod 
											...
											WHERE 1 = 1
												AND Stage_To_Prod_Key = $Processing_Key_Tier_9
												"
